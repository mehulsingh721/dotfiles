...
memoryBox = wibox.container.background(
    memoryWidget,
    {
        forced_height = 10,
        forced_width = 10,
...
vicious.register(memoryWidget, vicious.widgets.mem, "$2MiB/$3MiB", 13)

thermal = awful.widget.watch('bash -c "sensors | grep temp1"', 15)
