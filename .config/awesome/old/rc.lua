...
--awful.util.tagnames = {  " ", " ", " ", " ", " ", " ", " ", " ", " ", " "  }
awful.util.tagnames = { " CODE ", " WWW ", " API ", " SERVER ", " DB ", " CHAT ", " MUS ", " FILES ", " GFX " }
...
globalkeys = my_table.join(
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    -- awful.key({modkey,      "Ctrl"}, "Tab", function () awful.client.floating.toggle() end,
    --         {description = "jdfkfjdlkfjdklf", group = "awesome"}),
    ...
    awful.key({ modkey              }, "i", function () awful.spawn("brightnessctl s 5%+") end,
                { description = "increase brightness", group = "super"}),

    awful.key({ modkey              }, "d", function () awful.spawn("brightnessctl s 5%-") end,
                { description = "decrease brightness", group = "super"}),
...
awful.spawn.with_shell("feh --bg-scale ~/.config/awesome/themes/powerarrow-blue/starwars.jpg")
awful.spawn.with_shell("picom &")
awful.spawn.with_shell("nm-applet")
awful.spawn.with_shell("volumeicon")
awful.spawn.with_shell("barrier")
awful.spawn.with_shell("xinput set-prop 'ELAN0650:01 04F3:304B Touchpad' 'libinput Tapping Enabled' 1")
